...
* Also includes "bool isConnected(void);" method not in Arduino Mouse.h class.
*/
class BLE52_Mouse_
{
private:
...
public:
  ...
  bool isConnected(void);    //New method not in original Mouse.h
};

extern BLE52_Mouse_ Mouse;
 ...
 * Also includes "bool isConnected(void);" method not in Arduino Keyboard.h class.
 */

class BLE52_Keyboard_ : public Print
{
private:
  KeyReport _keyReport;
  void sendReport(KeyReport* keys);
public:
  BLE52_Keyboard_(void);
  void begin(char* s = "Bluefruit52");
  void end(void);
  ...
  bool isConnected(void);    //New method not in original Keyboard.h
};

extern BLE52_Keyboard_ Keyboard;
